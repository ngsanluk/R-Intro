...
R can read JSON files using the rjson package or others. JSON is very popular to present web api data.
...
reading another csv: using `import()` function
...
accessing inter-bank liquidity data from open data
